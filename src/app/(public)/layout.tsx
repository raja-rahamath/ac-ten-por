        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/services" className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-dark-900 dark:text-white">FixIT Pro</span>
            </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/login"
                className="px-4 py-2 text-sm font-medium text-dark-700 dark:text-dark-300 hover:text-dark-900 dark:hover:text-white transition-colors"
              >
                Sign In
              </Link>
              ...
              <Link
                ...
                className="px-5 py-2.5 rounded-lg font-semibold text-white
                         ...
                         transition-all duration-200 shadow-md shadow-primary-500/25"
              >
                Sign Up
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-dark-900 dark:text-white">FixIT Pro</span>
            </div>
